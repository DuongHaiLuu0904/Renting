...
public class SearchCarParnterFrm extends javax.swing.JFrame {
    ...
    public SearchCarParnterFrm(Client selectedClient, RentalAgent loggedInAgent) {
    ...
    private void initComponents() {
        ...
        setTitle("Search Car Parnter");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel1.setText("Tìm Kiếm Xe từ đối tác ");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        listCar = carDAO.searchCarPartner(pickupDate, returnDate);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SearchCarParnterFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new SearchCarParnterFrm().setVisible(true);
        });
    }
